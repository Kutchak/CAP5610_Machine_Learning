...
def magnitude(instance):
    return math.sqrt(dot_product(instance, instance))

def similarity(instance1, instance2):
    return dot_product(instance1, instance2) / (magnitude(instance1) * magnitude(instance2))
...
# dataset1 = loadCSV("tshirts-G.csv")
